    ...
    <section id="contact-me-section" className="contact-first-section">
                ...
                <div className="get-in-section">
                    ...
                    <div className="image-and-line">
                        <div className="profile-image-container">
                            <img  src={require("../images/my_image.jpg")} alt="Sidak Pic" className="hover-blur" />
            ...
            <div className="right-section">
                ...
                <div className="my-ending-line">
                    <p>"Through the harmonious rhythm of my keyboard and the graceful steps on the dance floor, I code my dreams into reality while letting the melodies of music guide my journey." - Sidak</p>
                    <div>
